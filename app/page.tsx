...
export default function HomePage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative bg-theme-secondary overflow-hidden">
      ...
      <SectionWrapper id="problem" variant="primary">
      ...
      <SectionWrapper id="how-it-works" variant="secondary">
      ...
      <SectionWrapper id="services" variant="primary">
        <div className="text-center mb-12 md:mb-16">
      ...
      <SectionWrapper id="why-me" variant="secondary">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-heading font-bold">
            Why Work With Me
          </h2>
